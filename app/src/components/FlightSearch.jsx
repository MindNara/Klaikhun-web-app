...
const FlightSearch = () => (
  <div className="bg-white rounded-xl shadow-lg h-48 flex flex-col px-8 py-5 space-y-3 w-full absolute">
    ...
    <div className="flex flex-row justify-between space-x-5">
      {/* <!-- From --> */}
      <div className="box bg-white border border-gray-2 rounded-xl flex flex-col justify-center px-8 py-6 w-[30%]">
      ...
      {/* <!-- Room & Guests --> */}
      <div className="box bg-white border border-gray-2 rounded-xl flex items-center justify-between px-8 py-6 w-[40%]">
        <div className="checkIn">
          <span className="text-gray-1 text-sm font-medium">DEPARTURE</span>
          <div>
            <span className="text-black text-3xl max-2xl:text-2xl font-bold mr-8">
              Sat, Feb 11
            </span>
